...
public class boss3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.position = new Vector3(345f, 3.41f, 0);
    ...
    void Update()
    {
        ...
        {
            cann.SetTrigger("isdead");
            mainbody.SetTrigger("isdead");
            fire.SetTrigger("isdead");
            startCounting = true;
            ...
            rb.enabled = false;
            audioManager.PlaySFX(audioManager.boss3_death);
        }
        if (startCounting)
        {
    ...
    void shoot()
    {
        ...
        if (math.abs(target.transform.position.x - transform.position.x) < 17f  /*&& !asm*/ )
        {
            ...
            fire.SetTrigger("fired");
            cann.SetTrigger("fired");
            Instantiate(cannons, pointOfShoot.position, pointOfShoot.rotation);
            audioManager.PlaySFX(audioManager.cannon_3);
